...
// Returns the private 'App\Repository\StagiaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StagiaireRepository.php';

return $this->privates['App\\Repository\\StagiaireRepository'] = new \App\Repository\StagiaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
