    ...
    var $addTagButton = $('<button type="button" class="add_stagiaire_link">Ajouter un module</button>');
    var $delTagButton = $('<button type="button" class="del_stagiaire_link">Supprimer</button>');
    ...
    $(document).ready(function() {
        //on pointe la liste complete (le conteneur de la collection)avec S
        var $collection = $("ul#dureeIntoSessions")
        ...
        $(".dureeIntoSession").each(function(){
