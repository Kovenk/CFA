...
// Returns the private 'App\Repository\DureeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DureeRepository.php';

return $this->privates['App\\Repository\\DureeRepository'] = new \App\Repository\DureeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
